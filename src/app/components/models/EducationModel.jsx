...
const EducationModel = ({
  ...
  const [formData, setFormData] = useState({
    ...
    grade: currentEducation?.grade?.percentage
      ? "percentage"
      : currentEducation?.grade?.cgpa
      ? "cgpa"
      : "percentage",
      ...
      grade: {
        percentage:
          formData.grade === "percentage"
            ? parseFloat(formData.gradePercentage)
            : undefined,
        cgpa:
          formData.grade === "cgpa"
            ? parseFloat(formData.gradeCGPA)
            : undefined,
      },
    };

    const updatedEducationData = Array.isArray(educationData)
      ? [...educationData]
      : [];
        ...
        <form onSubmit={handleSaveOrUpdate} className="edu-form">
          ...
          <div className="edu-info-text">
            <p style={{ fontSize: "13px", color: "#6b7280" }}>
              Example: If your degree is BTech in Electrical Engineering, then
              select Bachelor of Technology (BTech) in degree and Electrical
              Engineering as stream.
            </p>
          </div>

          <div
            className="edu-form-row"
          ...
          <div
            className="edu-form-group edu-checkbox-group"
            style={{
              display: "flex",
              flexDirection: "row",
              fontSize: "12px",
          ...
          >
            <label htmlFor="isCurrentlyEducating">
